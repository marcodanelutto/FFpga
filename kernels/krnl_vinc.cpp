...
static void compute_inc(hls::stream<uint32_t>& in1_stream,
...
void krnl_vinc(uint32_t* in1, uint32_t* out, int size) {
...
#pragma HLS dataflow
    ...
    compute_inc(in1_stream, out_stream, size);
