...
int main(int argc, char * argv[]) {
  ...
  p.add_stage(new ff_node_fpga("krnl_vadd", "../kernels/krnl_vall.xclbin", task_description));	// add FPGA stage (FPGA not found -> this fails)
  p.add_stage(new ff_node_fpga("krnl_vsub", "../kernels/krnl_vall.xclbin", task_description, false));	// add FPGA stage (FPGA not found -> this fails)
